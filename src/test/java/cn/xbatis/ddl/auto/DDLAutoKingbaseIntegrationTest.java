...
class DDLAutoKingbaseIntegrationTest extends DDLAutoExternalDatabaseIntegrationSupport {
    ...
    @Test
    void kingbaseShouldSyncAndDeleteMissingColumnsAndIndexes() throws Exception {
        try (Connection connection = openDatabaseConnectionOrSkip()) {
            assertSyncFlow(
                    DbType.KING_BASE,
                    connection,
    ...
    @Test
    void kingbaseShouldSyncTypeLengthAndDefaultCombinations() throws Exception {
        try (Connection connection = openDatabaseConnectionOrSkip()) {
    ...
    @Test
    void kingbaseShouldCreateColumnTypeMatrix() throws Exception {
        try (Connection connection = openDatabaseConnectionOrSkip()) {
    ...
    @Test
    void kingbaseShouldRemovePrimaryKeyAutoIncrementInSyncMode() throws Exception {
        try (Connection connection = openDatabaseConnectionOrSkip()) {
