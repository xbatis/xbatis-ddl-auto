...
class DDLAutoTest {
    ...
    @Test
    void h2ShouldSyncTypeLengthAndDefaultCombinations() throws Exception {
        try (Connection connection = openConnection("type_length_default")) {
    ...
    @Test
    void h2ShouldCreateColumnTypeMatrix() throws Exception {
        try (Connection connection = openConnection("column_type_matrix")) {
