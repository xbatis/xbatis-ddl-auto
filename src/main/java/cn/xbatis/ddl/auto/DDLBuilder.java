...
public interface DDLBuilder {
     ...
     * @param dbType      数据库类型
     * @param tableInfo   xbatis 表元数据
     * @param columns     需要修改默认值的列元数据集合
     * @param tableName   物理表名
     * @return 修改字段默认值 SQL 列表
     */
    default List<String> modifyColumnDefaultSqlList(IDbType dbType, TableInfo tableInfo, Collection<ColumnInfo> columns, String tableName) {
        Objects.requireNonNull(tableName, "tableName");
        return Collections.emptyList();
    }
     ...
     * @param dbType      数据库类型
     * @param tableInfo   xbatis 表元数据
     * @param columns     需要修改备注的列元数据集合
     * @return 修改字段备注 SQL 列表
     */
    default List<String> columnCommentSqlList(IDbType dbType, TableInfo tableInfo, Collection<ColumnInfo> columns) {
        Objects.requireNonNull(tableInfo, "tableInfo");
        return Collections.emptyList();
    }
     ...
     * @return 修改字段备注 SQL 列表
     */
    default List<String> columnCommentSqlList(IDbType dbType, TableInfo tableInfo, Collection<ColumnInfo> columns, String tableName) {
        Objects.requireNonNull(tableName, "tableName");
        return columnCommentSqlList(dbType, tableInfo, columns);
    }
